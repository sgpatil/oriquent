...
class MigrateCommand extends BaseCommand {
	...
	{
		return array(
			array('bench', null, InputOption::VALUE_OPTIONAL, 'The name of the workbench to orient.', null),
			...
			array('package', null, InputOption::VALUE_OPTIONAL, 'The package to orient.', null),
